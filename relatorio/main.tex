...
\section{Exercicio 3}
O pseudo código na Figura~\ref{caminhoscurtos} representa um algoritmo para encontrar os caminhos com maior numero de vértices, sem repetidos, entre dois pontos.
...
Aplicado ao problema em enunciado optemos o seguinte resultado:
\begin{enumerate}
	\item caminhos
\end{enumerate}
